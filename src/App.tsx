      ...
      <header className="App-header">
        ...
        <p>
            ...
            <li>
              ...
              Повезло. Без стажировки работу искал месяца 3, откликаясь только
              на вакансии компаний, чьими услугами я сам пользуюсь (ozon, avito,
            ...
            <li>
              ...
              <ul>
                ...
                <li>Express</li>
                <li>
                  авторизация (сессии (cookie-session/express-session), JWT)
                </li>
              ...
              <ul>
                ...
                <li>
                  сетевые запросы (XMLHttpRequest, fetch, axios, long polling,
                  websocket, server sent events)
                </li>
                <li>
                  хранение данных в браузере (cookie, localstorage,
                  sessionstorage)
                </li>
                <li>SQL</li>
              </ul>
              <b>
                Семантическая отзывчивая (резиновая) и адаптивная (по
                брейкпоинтам) верстка макетов Figma
              </b>
              <ul>
                ...
                <li>
                  использую Gulp – собственный конфиг (минификация кода, замена
                  форматов на webp, сжатие изображений, сборка webpack,
                  конвертация шрифтов, создание SVG спрайтов), в том числе c
                  плагинами, написанными и опубликованными мною в npm, и
              ...
              <ul>
                <li>
                  set, linked list, stack, queue/priority queue, hash-table,
                  graph, dfs/bfs traverse, binary tree, heap, trie
                </li>
                <li>
                  сортировка: selection sort, bubble sort, merge sort, quick
                  sort; поиск: binary search (3 разных паттерна)
                </li>
              ...
              <ul>
                ...
                <li>
                  регулярные выражения (использовал при написании плагина для
                  Gulp)
                </li>
                <li>
                  использовал UI-библиотеки: Mantine, Material UI, React
                  Bootstrap
                </li>
